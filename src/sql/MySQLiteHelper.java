...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String DATABASE_CREATE = "CREATE TABLE " + TABLE_TRANSACTIONS + "(" + COLUMN_ID
			+ " INTEGER PRIMARY KEY, " + COLUMN_FILEID + " INTEGER NOT NULL, " + COLUMN_REASON + " TEXT NOT NULL, "
			+ COLUMN_TIME + " INTEGER NOT NULL, " + COLUMN_WITHDRAWAL + " INTEGER NOT NULL, " + COLUMN_WOLTLABID
			+ " INTEGER NOT NULL, " + COLUMN_BALANCE + " REAL NOT NULL);";
