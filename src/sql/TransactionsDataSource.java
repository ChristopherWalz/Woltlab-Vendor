...
public class TransactionsDataSource {
	  ...
	  private String[] allColumns = { 
			  ...
			  MySQLiteHelper.COLUMN_FILEID,
			  MySQLiteHelper.COLUMN_REASON,
			  MySQLiteHelper.COLUMN_TIME,
			  MySQLiteHelper.COLUMN_WITHDRAWAL,
			  MySQLiteHelper.COLUMN_WOLTLABID,
	  ...
	  public Transaction create(int transactionID, int fileID, String reason, int time, int withdrawal, int woltlabID, float balance) {
	    ...
	    long insertId = database.insert(MySQLiteHelper.TABLE_TRANSACTIONS, null,
	        values);
	  ...
	  public void delete(int transactionID) {
	    ...
	    database.delete(MySQLiteHelper.TABLE_TRANSACTIONS, MySQLiteHelper.COLUMN_ID
	        + " = " + transactionID, null);
	  }
