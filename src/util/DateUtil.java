...
public final class DateUtil {
	...
	public final static CharSequence getRelativeDate(int timestamp) {
		CharSequence time = DateUtils.getRelativeTimeSpanString((long) timestamp * 1000, System.currentTimeMillis(),
	...
	public final static String getDate(int timestamp) {
		Date date = new Date(timestamp * 1000L); // *1000 is to convert seconds
													// to milliseconds
